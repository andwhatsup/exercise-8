...
@available_role_plan
+availableRole(Role, OrgName) : org_name(OrgName) & group_name(GroupName) & sch_name(SchemeName) <-
...
+!manifest_temperature : temperature(Celsius) & robot_td(Location) & org_name(OrgName) <-
	...
	makeArtifact("leubot1", "org.hyperagents.jacamo.artifacts.wot.ThingArtifact", [Location, true], Leubot);
